...
Overall rating: 4.0 stars from 1,418 reviews on Yelp. Add a "Read all 1,418 reviews on Yelp" button linking to https://www.yelp.com/biz/pho-duyen-mai-san-diego.

## Page layout (single page, sticky nav, smooth scroll)
1. Hero — business name, a strong tagline, and two buttons: "Order Online" and "Call (858) 560-5354".
...
## SEO
- Proper page title and meta description, Open Graph tags, and LocalBusiness JSON-LD structured data with the name, address, phone, hours, and 4.0 rating.
