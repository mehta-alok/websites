# Lovable Prompt — Ronald's Donuts (Las Vegas)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **Ronald's Donuts**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   Ronald's Donuts
BUSINESS TYPE:   donut shop
LOCATION:        Las Vegas, NV
FULL ADDRESS:    Las Vegas, NV
PHONE:           (702) 873-1032
RATING / VOLUME: 4.7★ from 1,214 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/ronalds-donuts-las-vegas
