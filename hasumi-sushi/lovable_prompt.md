# Lovable Prompt — Hasumi Sushi (Walnut Creek)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **Hasumi Sushi**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   Hasumi Sushi
BUSINESS TYPE:   Japanese restaurant
LOCATION:        Walnut Creek, CA
FULL ADDRESS:    3116 Oak Rd Ste A, Walnut Creek, CA 94597
PHONE:           (925) 949-8041
RATING / VOLUME: 4.2★ from 379 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/hasumi-sushi-walnut-creek
...
BRAND FEEL:      refined, minimal, modern — charcoal + cream + warm wood tones
