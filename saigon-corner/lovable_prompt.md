# Lovable Prompt — Saigon Corner Restaurant (Las Vegas)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **Saigon Corner Restaurant**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   Saigon Corner Restaurant
BUSINESS TYPE:   Vietnamese restaurant
LOCATION:        Las Vegas, NV
FULL ADDRESS:    Las Vegas, NV
PHONE:           (702) 202-4961
RATING / VOLUME: 4.6★ from 835 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/saigon-corner-restaurant-las-vegas
