...
Overall rating: 4.6 stars from 271 reviews on Yelp. Add a "Read all 271 reviews on Yelp" button linking to https://www.yelp.com/biz/annies-donuts-portland.

## Page layout (single page, sticky nav, smooth scroll)
1. Hero — business name, a strong tagline, and two buttons: "See the Menu" and "Call (503) 284-2752".
