# Lovable Prompt — Taqueria Senaida's
...
## The business
- Name: Taqueria Senaida's
- Type: authentic Mexican kitchen
- Location: 150 W Tennyson Rd, Hayward, CA
- Phone: (510) 783-6031
- Hours:
...
Overall rating: 4.5 stars from 787 reviews on Yelp. Add a "Read all 787 reviews on Yelp" button linking to https://www.yelp.com/biz/taqueria-senaidas-hayward.

## Page layout (single page, sticky nav, smooth scroll)
1. Hero — business name, a strong tagline, and two buttons: "Order Online" and "Call (510) 783-6031".
