# Lovable Prompt — Tita's Kitchenette (National City)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **Tita's Kitchenette**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   Tita's Kitchenette
BUSINESS TYPE:   Filipino restaurant
LOCATION:        National City, CA
FULL ADDRESS:    National City, CA
PHONE:           (619) 434-3879
RATING / VOLUME: 4.5★ from 1,406 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/titas-kitchenette-national-city
...
BRAND FEEL:      warm, generous, homey — terracotta + tropical accents
...
VERBATIM YELP REVIEWS (display these in the Reviews section, exactly as written):
  - "Tita's in National City never disappoints! Best sinigang there is." — Verified Customer
  - "Lechon — just perfect." — Verified Customer
```
