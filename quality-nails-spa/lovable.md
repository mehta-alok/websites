# Lovable Prompt — Quality Nails & Spa
...
Overall rating: 4.1 stars from 1,012 reviews on Yelp. Add a "Read all 1,012 reviews on Yelp" button linking to https://www.yelp.com/biz/quality-nails-and-spa-long-beach.

## Page layout (single page, sticky nav, smooth scroll)
1. Hero — business name, a strong tagline, and two buttons: "Book Appointment" and "Call (562) 985-3035".
...
## SEO
- Proper page title and meta description, Open Graph tags, and LocalBusiness JSON-LD structured data with the name, address, phone, hours, and 4.1 rating.
