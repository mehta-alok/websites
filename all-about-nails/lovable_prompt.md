# Lovable Prompt — All About Nails (Oakland)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **All About Nails**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   All About Nails
BUSINESS TYPE:   nail salon
LOCATION:        Oakland, CA
FULL ADDRESS:    Oakland, CA
PHONE:           (510) 834-6910
RATING / VOLUME: 4.8★ from 285 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/all-about-nails-oakland
...
VERBATIM YELP REVIEWS (display these in the Reviews section, exactly as written):
  - "Jeannie is by far the most skilled, precise, and detail-oriented person I've ever had work on my feet." — Verified Customer
  - "All the technicians are great at gel manis." — Verified Customer
```
