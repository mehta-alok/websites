# Lovable Prompt — Taqueria Mar y Tierra
...
## The business
- Name: Taqueria Mar y Tierra
- Type: authentic Mexican kitchen
- Location: 754 W A Street, Hayward, CA
- Phone: (510) 786-4150
- Hours:
...
Overall rating: 4.3 stars from 236 reviews on Yelp. Add a "Read all 236 reviews on Yelp" button linking to https://www.yelp.com/biz/taqueria-mar-y-tierra-hayward-2.

## Page layout (single page, sticky nav, smooth scroll)
1. Hero — business name, a strong tagline, and two buttons: "Order Online" and "Call (510) 786-4150".
