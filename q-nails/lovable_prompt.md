# Lovable Prompt — Q-Nails (Fremont)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **Q-Nails**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   Q-Nails
BUSINESS TYPE:   nail salon
LOCATION:        Fremont, CA
FULL ADDRESS:    40978 Fremont Boulevard, Fremont, CA 94538
PHONE:           (510) 226-8882
RATING / VOLUME: 4.5★ from 306 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/q-nails-fremont
...
VERBATIM YELP REVIEWS (display these in the Reviews section, exactly as written):
  - "I love Q-Nails and they always treat me like family." — Verified Customer
  - "The staff did an amazing job, and the foot massage was the best one I've had." — Verified Customer
  - "Amazed by their warm welcome and top-notch service." — Verified Customer
```
