# Lovable Prompt — One Hour Alterations (San Jose)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **One Hour Alterations**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   One Hour Alterations
BUSINESS TYPE:   tailor & alterations shop
LOCATION:        San Jose, CA
FULL ADDRESS:    2242 S King Road, San Jose, CA 95122
PHONE:           (408) 259-4113
RATING / VOLUME: 4.6★ from 130 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/one-hour-alterations-san-jose
...
BRAND FEEL:      refined, elegant, careful craft — sage + cream + warm neutrals
