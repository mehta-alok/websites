# Lovable Prompt — Comedor Guadalajara (Phoenix)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **Comedor Guadalajara**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   Comedor Guadalajara
BUSINESS TYPE:   Mexican restaurant
LOCATION:        Phoenix, AZ
FULL ADDRESS:    Phoenix, AZ
PHONE:           (602) 253-8299
RATING / VOLUME: 4.4★ from 841 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/comedor-guadalajara-phoenix
...
VERBATIM YELP REVIEWS (display these in the Reviews section, exactly as written):
  - "One of the best chile rellenos I ever had!" — Verified Customer
  - "The portions are huge, the food is delicious, nice service." — Verified Customer
  - "Friendly help, great service, good food, good prices, clean bathrooms!" — Verified Customer
```
