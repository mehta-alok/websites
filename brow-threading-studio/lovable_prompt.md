# Lovable Prompt — Brow Threading Studio (San Jose)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **Brow Threading Studio**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
