# Lovable Prompt — House of Pho (Hayward)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **House of Pho**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   House of Pho
BUSINESS TYPE:   Vietnamese restaurant
LOCATION:        Hayward, CA
FULL ADDRESS:    20500 Hesperian Blvd Ste B, Hayward, CA 94541
PHONE:           (510) 578-3533
RATING / VOLUME: 4.3★ from 366 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/house-of-pho-hayward
OWNER EMAIL:     [owner's email — to be added]     ← booking + contact notifications go here
HOURS:
  - Mon – Fri: 10:00 AM – 8:45 PM
  - Sat – Sun: 10:00 AM – 9:00 PM
TODAY'S HOURS:   10:00 AM – 8:45 PM
