# Lovable Prompt — Top Cut Barber Salon
...
## The business
- Name: Top Cut Barber Salon
- Type: classic barbershop
- Location: 3818 Piedmont Avenue, Oakland, CA
- Phone: (510) 547-1205
- Hours:
...
Overall rating: 4.3 stars from 200 reviews on Yelp. Add a "Read all 200 reviews on Yelp" button linking to https://www.yelp.com/biz/top-cut-barber-salon-oakland-2.

## Page layout (single page, sticky nav, smooth scroll)
1. Hero — business name, a strong tagline, and two buttons: "Book a Cut" and "Call (510) 547-1205".
