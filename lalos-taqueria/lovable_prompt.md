# Lovable Prompt — Lalo's Taqueria (Hayward)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **Lalo's Taqueria**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
> 5. In Supabase Auth, add one user with **Lalo**'s email + a password. That's their admin login.
...
```
BUSINESS NAME:   Lalo's Taqueria
BUSINESS TYPE:   Mexican restaurant
LOCATION:        Hayward, CA
FULL ADDRESS:    28293 Mission Boulevard, Hayward, CA 94544
PHONE:           (510) 940-0137
RATING / VOLUME: 4.5★ from 323 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/lalo-s-taqueria-hayward
OWNER EMAIL:     lalosbusiness9@gmail.com     ← booking + contact notifications go here
HOURS:
...
VERBATIM YELP REVIEWS (display these in the Reviews section, exactly as written):
  - "One of the best tacos I have ever had in my life." — Verified Customer
  - "The beef quesabirria are delicious. The meat is very tender and the dipping jus is so good." — Verified Customer
  - "Lalo obviously cares about the food he makes." — Verified Customer
```
