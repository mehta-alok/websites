# Lovable Prompt — Phoenix Appliance Services (Phoenix)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **Phoenix Appliance Services**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   Phoenix Appliance Services
BUSINESS TYPE:   appliance repair service
LOCATION:        Phoenix, AZ
FULL ADDRESS:    Phoenix, AZ
PHONE:           (623) 292-7152
RATING / VOLUME: 4.5★ from 367 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/phoenix-appliance-services-phoenix-3
...
BRAND FEEL:      trustworthy, professional, fast — navy + gold accents
