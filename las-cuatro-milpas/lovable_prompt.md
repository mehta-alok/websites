# Lovable Prompt — Las Cuatro Milpas (San Diego)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **Las Cuatro Milpas**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   Las Cuatro Milpas
BUSINESS TYPE:   Mexican restaurant
LOCATION:        San Diego, CA
FULL ADDRESS:    San Diego, CA
PHONE:           (619) 234-4460
RATING / VOLUME: 4.5★ from 2,928 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/las-cuatro-milpas-san-diego-2
OWNER EMAIL:     [owner's email — to be added]     ← booking + contact notifications go here
HOURS:
  - Mon – Thu: 11:00 AM – 9:00 PM
  - Fri – Sat: 11:00 AM – 10:00 PM
  - Sunday: 11:00 AM – 9:00 PM
TODAY'S HOURS:   8:30 AM – 3:00 PM
...
VERBATIM YELP REVIEWS (display these in the Reviews section, exactly as written):
  - "The rolled tacos were good — the tortillas, rice, and beans were perfect." — Verified Customer
  - "The beans were outstanding." — Verified Customer
```
