# Lovable Prompt — PhilHouse (Vallejo)

> **What this is.** A ready-to-paste prompt that tells Lovable to build a fully functional website (real booking/reservation/quote system + owner admin dashboard) for **PhilHouse**. Real data, real Yelp reviews, real address — already filled in.
>
> **How to use.**
...
```
BUSINESS NAME:   PhilHouse
BUSINESS TYPE:   Filipino restaurant
LOCATION:        Vallejo, CA
FULL ADDRESS:    2110 Spring Rd Ste 24A, Vallejo, CA 94591
PHONE:           (707) 645-8971
RATING / VOLUME: 4.3★ from 158 verified Yelp reviews
YELP URL:        https://www.yelp.com/biz/philhouse-vallejo
